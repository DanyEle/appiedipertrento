 ...
 * 
 * It is intended to be helpful, and get your projects up and running quickly,
 * but is not part of the official Sensordrone API. Your mileage may vary :-)
 * 
...
public class SDHelper {
	 ...
	 * 
	 * @param drone
	 *            The Drone to connect
	 * @param context
	 *            Your context (for displaying a Dialog)
	 * @param includePairedDevices
	 *            True if you want to include the phone's paired devices in the
	 *            list
	 */
	 ...
	 * 
	 * Note There are Thread.sleep() calls for delay in between flashing. If you
	 * call this immediately before disconnecting, all of the blinks might not
	 * be processed!
	 * 
	 * @param drone
	 *            The Drone
	 * @param nFlashes
	 *            How many times do we flash?
	 * @param delay_ms
	 *            Delay between flashes in ms
	 * @param Red
	 *            0-255
	 * @param Green
	 *            0-255
	 ...
	 *            0-255
	 */
	public void flashLEDs(Drone drone, int nFlashes, int delay_ms, int Red,
			int Green, int Blue) {
